...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"653173396679665e4d35344f4c2d6e3c",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=studentm&table=students">
    `studentm`.`students`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=studentm&table=courses">
    `studentm`.`courses`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=studentm&table=sessions">
    `studentm`.`sessions`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=studentm&table=departments">
    `studentm`.`departments`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=sttm&table=migrations">
    `sttm`.`migrations`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=sttm&table=students">
    `sttm`.`students`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=stmm&table=students">
    `stmm`.`students`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=stm&table=migrations">
    `stm`.`migrations`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=dbstudentsms&table=batches">
    `dbstudentsms`.`batches`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=example&table=lawyers">
    `example`.`lawyers`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.YWpheA==" data-pos="0"></span>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.YWpheA==" data-vpath="cm9vdA==.YWpheA==." data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=ajax"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=ajax" title="Structure">ajax</a>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.YWpheF9jdXJk" data-vpath="cm9vdA==.YWpheA==.Y3VyZA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=ajax_curd"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=ajax_curd" title="Structure">ajax_curd</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZGJzdHVkZW50c21z" data-vpath="cm9vdA==.ZGJzdHVkZW50c21z" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=dbstudentsms"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=dbstudentsms" title="Structure">dbstudentsms</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZXhhbXBsZQ==" data-vpath="cm9vdA==.ZXhhbXBsZQ==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=example"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=example" title="Structure">example</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.bGFyYTEx" data-vpath="cm9vdA==.bGFyYTEx" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=lara11"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=lara11" title="Structure">lara11</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.bXVsdGlhdXRoZW4=" data-vpath="cm9vdA==.bXVsdGlhdXRoZW4=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=multiauthen"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=multiauthen" title="Structure">multiauthen</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.bXlwcm9qZWN0" data-vpath="cm9vdA==.bXlwcm9qZWN0" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=myproject"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=myproject" title="Structure">myproject</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c3R1ZGVudG0=" data-vpath="cm9vdA==.c3R1ZGVudG0=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=studentm"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=studentm" title="Structure">studentm</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="653173396679665e4d35344f4c2d6e3c">
